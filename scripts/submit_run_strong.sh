#!/usr/bin/env bash
# Pack run_strong adv images into submission.zip.
# WSL: change /c/ -> /mnt/c/
...
/c/Users/admin/miniconda3/envs/causal/python.exe -u \
    ...
    --out-zip   /c/文件/ME/AISCI/Dr.Researcher/projects/aisafety-cifar10-attack/workspace/results/run_strong/submission.zip
